...
- 游戏：Pebble Pocket
- 类型：casual
- 简述：One stone a day. Press the sand and the tide brings back a single AI-generated pebble — quartz, amber, slate, jasper. Come back tomorrow for more. A pure daily ritual, a slowly-filling pocket.
...
- 平台元信息：meta.title=Pebble Pocket；cover_url=/poster.png；category=casual；uuid=7c39f0f8-b949-4726-bf21-ef788980c5c7
...
- `src/PebblePocket/PebblePocket.tsx`：React 组件和交互界面。
- `src/PebblePocket/PebblePocket.less`：视觉样式、布局、动画和响应式规则。
- `src/PebblePocket/index.ts`：游戏源码模块。
- `src/PebblePocket/utils/audio.ts`：游戏源码模块。
- `src/PebblePocket/utils/genImageWithRetry.ts`：游戏源码模块。
- `src/PebblePocket/utils/notifyLog.ts`：游戏源码模块。
- `src/PebblePocket/utils/prompts.ts`：游戏源码模块。
- `src/PebblePocket/utils/dayKey.ts`：游戏源码模块。
...
- `src/vite-env.d.ts`
- `src/game-id.ts`
- `src/PebblePocket/PebblePocket.tsx`
- `src/PebblePocket/PebblePocket.less`
- `src/PebblePocket/index.ts`
- `src/PebblePocket/utils/audio.ts`
- `src/PebblePocket/utils/genImageWithRetry.ts`
- `src/PebblePocket/utils/notifyLog.ts`
- `src/PebblePocket/utils/prompts.ts`
- `src/PebblePocket/utils/dayKey.ts`
- `src/PebblePocket/hooks/usePebbles.ts`
- `src/PebblePocket/hooks/useTide.ts`
- `src/PebblePocket/i18n/index.ts`
